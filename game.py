...
def ask(question: str):
    ...
    answer = "The answer is the man was in airplan trying to jump with a backpack was holding a parachute, the parachute did not open and the man died.The man was airplane pilot. the man was using a brown shirt and yellow pants"
